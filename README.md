...
[![Go Reference](https://pkg.go.dev/badge/github.com/d-protocol/twitter.svg)](https://pkg.go.dev/github.com/d-protocol/twitter)
...
```shell
go get -u github.com/d-protocol/twitter
```
...
import (
    "context"
    "fmt"
    twitterscraper "github.com/d-protocol/twitter"
)
